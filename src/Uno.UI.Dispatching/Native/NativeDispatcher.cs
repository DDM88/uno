...
namespace Uno.UI.Dispatching
{
	...
	internal sealed partial class NativeDispatcher
	{
		...
		/// </summary>
		private readonly Queue<Action>[] _queues = new[]
		{
			new Queue<Action>(), // High
			new Queue<Action>(), // Normal
			new Queue<Action>(), // Low
			new Queue<Action>(), // Idle
		};
		...
		private void EnqueueCore(Action handler, NativeDispatcherPriority priority)
		{
